...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 02, 2019 lúc 03:53 AM
...
CREATE TABLE `bookingticket` (
  ...
  `idghe` int(255) NOT NULL,
  `makh` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `idphim` int(255) NOT NULL,
  `ngaydatve` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `tinhtrang` varchar(256) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `bookingticket`
--

INSERT INTO `bookingticket` (`id`, `idlichchieu`, `idghe`, `makh`, `idphim`, `ngaydatve`, `tinhtrang`) VALUES
(1, 1, 1, '10', 122, '', 'thanh cong'),
(3, 2, 0, '10', 121, '', ''),
(4, 3, 0, '', 122, '29/11/2019', ''),
(5, 4, 4, '10', 122, '29/11/2019', 'thanh cong');
...
(3, 25, 2, 'local', 'images/video/film121-2.mp4');
...
CREATE TABLE `ghe` (
  `idghe` int(255) NOT NULL,
  `tenghe` varchar(256) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `lichchieu` (
  `idlichchieu` int(255) NOT NULL,
  `idphim` int(255) NOT NULL,
  `thoigianchieu` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `ngaychieu` varchar(256) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `lichchieu` (`idlichchieu`, `idphim`, `thoigianchieu`, `ngaychieu`) VALUES
(1, 122, '21h00', '29/11/2019'),
(2, 121, '17h00', ''),
(3, 122, '23h30', ''),
(4, 121, '15h30', '');
...
(4, 'thanhtuong', '', '$2y$10$Ro5NSgkdC914wjSIo1znhOYF9n0hQ1K50v3O30720eCdion7qQLjO', 'thanhtuong@gmail.com', '1998-09-16', 'male', 99),
(5, 'mimi', 'mimi', '$2y$10$Ro5NSgkdC914wjSIo1znhOYF9n0hQ1K50v3O30720eCdion7qQLjO', 'mimi@gmail.com', '1999-09-16', 'female', 20),
(6, 'VoThi', 'mimi', '$2y$10$Ro5NSgkdC914wjSIo1znhOYF9n0hQ1K50v3O30720eCdion7qQLjO', 'vtmimi@gmail.com', '1999-09-16', 'female', 10),
(10, 'nguyenthanhtuong', 'Nguyen Thanh Tuong', '$2y$10$tiWCDJjzl.ql7mv9thlbxepfREJzhcRS7fzhXCp6USBXZPpofVvZy', 'pt.nguyenthanhtuong@gmail.com', '0000-00-00', 'male', 99);
...
--
ALTER TABLE `ghe`
  MODIFY `idghe` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `lichchieu`
--
ALTER TABLE `lichchieu`
  MODIFY `idlichchieu` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
